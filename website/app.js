...
(function () {
  ...
  var DE = {
    ...
    'zahlen.04.label': 'Systeme per CLI und MCP',
    ...
    'saeule.01.absatz1': 'Im Kern sitzt ein Port, kein Anbieter. OpenAI, Anthropic, Google — oder lokal über Ollama und MLX-LM, dann verlässt kein Wort deinen Rechner. Alles andere mit OpenAI-Schnittstelle trägst du mit seiner Adresse ein: LM Studio, vLLM, euer Gateway.',
    ...
    'saeule.01.demo.hinweis': 'Sechs Anbieter, ein Port. Drei davon rechnen auf deinem Rechner.',
    ...
    'saeule.03.absatz2': 'Der zweite Weg ist das Model Context Protocol. Ein MCP-Server bringt die Werkzeuge eines Systems selbst mit — Jira, Confluence, eine Datenbank, eure interne API. Eingetragen wird er unter Einstellungen, danach steht er im Chat. Eine neue Fähigkeit kommt per Konfiguration, nicht per Release.',
    ...
    'saeule.03.demo.caption3': '// mcp-server, wie sie in den einstellungen stehen',
    'saeule.03.demo.mcp.jira': '9 Werkzeuge',
    'saeule.03.demo.mcp.confluence': '6 Werkzeuge',
    'saeule.03.demo.mcp.haus.name': 'euer-haus-server',
    'saeule.03.demo.mcp.haus': '4 Werkzeuge',
  ...
  var EN = {
    ...
    'zahlen.04.label': 'systems via CLI and MCP',
    ...
    'saeule.01.absatz1': "At the core there's a port, not a vendor. OpenAI, Anthropic, Google — or locally via Ollama and MLX-LM, and then not a word leaves your computer. Anything else that speaks the OpenAI interface you add by its address: LM Studio, vLLM, your company gateway.",
    ...
    'saeule.01.demo.hinweis': 'Six providers, one port. Three of them run on your own machine.',
    ...
    'saeule.03.absatz2': 'The second route is the Model Context Protocol. An MCP server brings a system\u2019s own tools with it — Jira, Confluence, a database, your internal API. You add it in the settings, and from then on it is there in the chat. A new capability arrives by configuration, not by release.',
    ...
    'saeule.03.demo.caption3': '// mcp servers, the way they sit in the settings',
    'saeule.03.demo.mcp.jira': '9 tools',
    'saeule.03.demo.mcp.confluence': '6 tools',
    'saeule.03.demo.mcp.haus.name': 'your-company-server',
    'saeule.03.demo.mcp.haus': '4 tools',
