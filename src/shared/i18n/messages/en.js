...
module.exports = {
  ...
  'settings.applyHint.memory': 'Forgotten entries are gone <strong>immediately</strong>; the switches take effect on <strong>Apply</strong>.',
  ...
  'settings.general.locale.select': 'Language',
