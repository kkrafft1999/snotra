...
- **So, wie du die App verlassen hast:** Beim Start holt Snotra die zuletzt geführte Konversation des Ordners zurück. Ist eine da, bleibt die mittlere Spalte zu und du landest direkt im Gespräch statt neben „Womit fangen wir an?“ — der Startschirm gehört zum kalten Start und erscheint nur, wenn es nichts fortzusetzen gibt. Das Fenster geht mit 1536 × 960 Punkten auf, auf kleineren Bildschirmen so groß, wie die Arbeitsfläche hergibt.
